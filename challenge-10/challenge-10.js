(function() {
    ...
    */
    function isOperatorValid(operator) {
        ...
        /* 
            Se eu passar um + para a função [console.log(isOperationValid('+')] ele irá me retornar o valor desse operador (function).
            Se esse operador não existir, irá retornar undefined. Então basta verificar se o operator é diferente de undefined.
            Além disso, não há repetição de código, basta adicionar novos operadores no objeto operation.
        */
        ...
        //Solução 2
        /**
         * Função booleanmente falando é truthy e undefined é falsy. Dessa forma basta adicionar o equivalente booleano.
         */
    ...
    */
    //Se sum for uma função, será true, entrará no if.
    if(sum) {
        number1 = 10;
        number2 = 12;
